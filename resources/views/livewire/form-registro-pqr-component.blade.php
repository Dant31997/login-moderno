    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-center align-items-center"
            style="min-height: 80vh; background-color: #f7f7f7;">
            <form wire:submit.prevent="save" class="shadow-lg p-4 rounded-lg bg-white w-75"
                style="margin-top: -100px; z-index: 10;">
                ...
                <!-- Nombre Completo -->
                <div class="mb-3">
                    <label for="nombreCompleto" class="form-label fw-bold"><i class="fas fa-user"></i> Nombre
                        Completo</label>
                ...
                <!-- Número de Cuenta -->
                <div class="mb-3">
                    <label for="numeroCuenta" class="form-label fw-bold"><i class="fas fa-credit-card"></i> Número de
                        Cuenta</label>
                ...
                <!-- Correo Electrónico -->
                <div class="mb-3">
                    <label for="correo" class="form-label fw-bold"><i class="fas fa-envelope"></i> Correo
                        Electrónico</label>
                ...
                <div class="mb-3">
                    <label for="telefono" class="form-label fw-bold"><i class="fas fa-phone"></i> Teléfono de
                        Contacto</label>
                ...
                <!-- Tipo de Petición -->
                <div class="mb-3">
                    <label for="tipoPeticion" class="form-label fw-bold"><i class="fas fa-question-circle"></i> Tipo de
                        Petición</label>
                    <select id="tipoPeticion" wire:model.live="tipoPeticion" class="form-select bg-light form-control"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="radio" id="contactoTelefono" wire:model.live="preferenciaContacto"
                            value="telefono" class="form-check-input" required>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" id="consentimiento" wire:model.live="consentimiento"
                        class="form-check-input" required>
                    <label for="consentimiento" class="form-check-label">Acepto los <a href="#"
                            class="text-primary text-decoration-underline">términos y condiciones</a> y la <a
                            href="#" class="text-primary text-decoration-underline">política de
                            privacidad</a>.</label>
                </div>

                <!-- Botón Guardar -->
                <div class="d-grid">
                    <button type="submit" class="btn btn-success btn-lg"><i class="fas fa-paper-plane"></i> Enviar
                        formulario</button>
                </div>
            </form>
